...
output_dir="/home/ubuntu/bigdata_cs838/results/q2_${query_id}/$1/$6/$7/try_$trial/$3"
...
echo "\n##### script_q2_tez.sh $1 $2 $3 $4 $5 $6 $7 START #####"
...
#	echo "newPass123123$" | sudo -S sh -c "sync; echo 3 > /proc/sys/vm/drop_caches"
	...
	echo "##### script_q2_tez.sh $1 $2 $3 $4 $5 $6 $7 DONE #####\n"
fi
