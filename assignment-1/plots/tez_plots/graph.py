...
for filename in matches:
	...
	plt.legend(['readers + aggregators', 'readers', 'aggregators'], loc='best')
	#plt.show()
	...
	plt.title("Task distribution over query lifetime: Query {0}; Hive/Tez".format(filename.split("tez")[0].split("query")[1] ))
	plt.xlabel("Time")
