        ...
        for type in "${tez_or_mr[@]}"  				
        	do
                ...
                do
                        ...
                        python parser.py "/u/v/a/vaibhav/private/838/assign1/query_run_output/q1/${query_id}/mr/try_$i/master/history/" > intermediate_files/mr_query_${query_id}_try_${i}.txt 
