...
path = os.path.join('/u/a/p/aparnasubr/Documents/Fall2016/838/tez_plots', sys.argv[1])
number = sys.argv[1]
vertex_data = {}
task_all_data = {}
task_map_data = {}
...
print "All data {0}".format(len(task_all_list))
...
print "Map data {0}".format(len(task_map_list))
...
print "Reduce data {0}".format(len(task_reduce_list))
