...
ENV="JAVA_HOME=/usr/lib/jvm/java-1.7.0-openjdk-amd64 \
  ...
  SPARK_MASTER_HOST=10.254.0.83 \
  ZOOKEEPER_BIN_PATH=/home/ubuntu/software/zookeeper-3.4.6/bin \
  STORM_BIN_PATH=/home/ubuntu/software/apache-storm-1.0.2/bin"
...
export PATH=/home/ubuntu/software/hadoop-${COMMON_VERSION}/bin:/home/ubuntu/software/hadoop-${COMMON_VERSION}/sbin:$HIVE_HOME/bin:/home/ubuntu/software/spark-2.0.0-bin-hadoop2.6/bin:/home/ubuntu/software/spark-2.0.0-bin-hadoop2.6/sbin:$STORM_BIN_PATH:$PATH
...
#    $ZOOKEEPER_BIN_PATH/zkServer.sh start
    pdsh -R exec -f $THREADS -w ^machines ssh -o ConnectTimeout=$TIMEOUT %h '( . /home/ubuntu/run.sh -q ; $ZOOKEEPER_BIN_PATH/zkServer.sh start;)'
 #   $ZOOKEEPER_BIN_PATH/zkServer.sh start-foreground
}

stop_zookeeper(){
    printf "\n==== STOP ZOOKEEPER ! ====\n"
#    $ZOOKEEPER_BIN_PATH/zkServer.sh stop
    pdsh -R exec -f $THREADS -w ^machines ssh -o ConnectTimeout=$TIMEOUT %h '( . /home/ubuntu/run.sh -q ; $ZOOKEEPER_BIN_PATH/zkServer.sh stop;)'
}

start_storm(){
    printf "\n==== START STORM ! ====\n" 
#    $STORM_BIN_PATH/storm nimbus &
    pdsh -R exec -f 5 -w ^machines ssh -o ConnectTimeout=$TIMEOUT %h "$STORM_BIN_PATH/storm supervisor &"
}

stop_storm(){
    printf "\n==== STOP STORM ! NOT IMLPEMENTED... ====\n"
