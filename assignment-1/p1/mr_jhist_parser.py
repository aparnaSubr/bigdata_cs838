...
def parse_file(file_name):
    with open(file_name) as f:
        ...
        with open(output_path + file_name, "w+") as out_f:
...
if __name__ == "__main__":
    parse_file("job_1474646819922_0019-1474649429457-ubuntu-select++%0A+++s_store_name%0A++%2Cs_company_...100%28Stage-1474649450238-2-1-SUCCEEDED-default-1474649435143.jhist")
